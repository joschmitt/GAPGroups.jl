...
function __init__()
  append!(_gap_group_types,
    [
        (GAPGroups.GAP.Globals.IsPermGroup, PermGroup),
        (GAPGroups.GAP.Globals.IsPcGroup, PcGroup),
        (GAPGroups.GAP.Globals.IsMatrixGroup, MatrixGroup),
        (GAPGroups.GAP.Globals.IsFpGroup, FPGroup),
    ])

 append!(_iso_function,
    [
        (PermGroup, GAP.Globals.IsomorphismPermGroup),
